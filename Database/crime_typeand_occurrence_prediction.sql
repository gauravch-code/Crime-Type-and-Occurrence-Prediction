...
--
-- Database: `crime_typeand_occurrence_prediction`
--
CREATE DATABASE IF NOT EXISTS `crime_typeand_occurrence_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `crime_typeand_occurrence_prediction`;
...
--
-- Table structure for table `remote_user_crime_details`
--

CREATE TABLE IF NOT EXISTS `remote_user_crime_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `INCIDENT_NUMBER` varchar(300) NOT NULL,
  `OFFENSE_CODE` varchar(300) NOT NULL,
  `OFFENSE_CODE_GROUP` varchar(300) NOT NULL,
  `OFFENSE_DESCRIPTION` varchar(300) NOT NULL,
  `DISTRICT` varchar(300) NOT NULL,
  `REPORTING_AREA` varchar(300) NOT NULL,
  `OCCURRED_ON_DATE` varchar(300) NOT NULL,
  `YEAR` varchar(300) NOT NULL,
  `MONTH` varchar(300) NOT NULL,
  `DAY_OF_WEEK` varchar(300) NOT NULL,
  `Hour` varchar(300) NOT NULL,
  `UCR_PART` varchar(300) NOT NULL,
  `STREET` varchar(300) NOT NULL,
  `Lat` varchar(300) NOT NULL,
  `Long1` varchar(300) NOT NULL,
...
--
-- Table structure for table `remote_user_crime_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_crime_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `INCIDENT_NUMBER` varchar(300) NOT NULL,
  `OFFENSE_CODE` varchar(300) NOT NULL,
  `OFFENSE_CODE_GROUP` varchar(300) NOT NULL,
